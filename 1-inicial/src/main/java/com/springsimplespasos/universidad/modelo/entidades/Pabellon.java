package com.springsimplespasos.universidad.modelo.entidades;
...
public class Pabellon implements Serializable {
	...
	@OneToMany(mappedBy = "pabellon", fetch = FetchType.LAZY, cascade = CascadeType.MERGE)
	...
	public String toString() {
		return "Pabellon{" + "id=" + id + ", mts2=" + mts2 + ", nombre='" + nombre + '\'' + ", direccion=" + direccion
				+ ", fechaAlta=" + fechaAlta + ", fechaUltimaModificacion=" + fechaModificacion + '}';
	}
